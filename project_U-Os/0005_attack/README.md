...
6. **Generate probability tables with template attack and belief propagation**  
   ...
   - Tables for 1-bit key fragments with probabilities estimated after loopy belief propagation on marginalized information from templates for all targeted intermediate values in an encryption (the _loopy_ attack)  
