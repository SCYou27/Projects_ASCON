...
def tag2byte(my_string):
  if len(my_string)==32:
    Output = []
    for bt in range(0, 16):
      Output.append((16*hexdict[my_string[(2*bt)]]+hexdict[my_string[(2*bt+1)]]))
